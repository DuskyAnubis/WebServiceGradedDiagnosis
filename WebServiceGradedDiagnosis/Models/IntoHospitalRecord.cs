...
namespace WebServiceGradedDiagnosis.Models
{
    public class IntoHospitalRecord
    {
        ...
        public string HisAcqudata { get; set; }
        public string CaseStatement { get; set; }
        public string GreatDegree { get; set; }
        public string RecordDate { get; set; }
        public string BedNo { get; set; }
        public string Rcvsection { get; set; }
        ...
        public string HoudoctNo { get; set; }
        public string Houdoct { get; set; }
